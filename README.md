...
- Редакция на вече създадени въпроси
- Множествено верни отговори (multi-select)
- Време за отговор на всеки въпрос (в секунди)
...
- Таймер при ученика за всеки въпрос с автоматично изтичане (`TIME_EXPIRED`)
